...
public class MainActivity5 extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewPlayer1 = findViewById(R.id.text_view_player1score);
        textViewPlayer2 = findViewById(R.id.text_view_player2score);
        ...
        Button buttonReset = findViewById(R.id.resetboard);
    ...
    private void player1Wins() {
        player1Points++;
        Toast.makeText(this, "Player 1 is KING!", Toast.LENGTH_SHORT).show();
        updatePointsText();
        resetBoard();
    }
    ...
    private void player2Wins() {
        player2Points++;
        Toast.makeText(this, "Player 2 is KING!", Toast.LENGTH_SHORT).show();
        updatePointsText();
        resetBoard();
    }
